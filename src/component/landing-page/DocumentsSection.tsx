    ...
    <section className="py-16 px-4" style={{ backgroundColor: "var(--background)" }}>
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-earth-dark">Dokumen Desa</h2>
          <p className="text-lg max-w-2xl mx-auto text-earth-muted">Kumpulan dokumen penting desa yang dapat Anda lihat dan unduh</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {documents.map((doc) => (
            <a key={doc.id} href={doc.fileUrl} target="_blank" rel="noopener noreferrer" className="group card-earth p-6">
              <div className="flex items-start gap-4">
        ...
        <div className="text-center mt-10">
          <Link href="/documents" className="inline-flex items-center gap-2 px-6 py-3 rounded-lg font-medium transition-all duration-300 hover:scale-105 active:scale-95" style={{ backgroundColor: "var(--primary)", color: "white" }}>
