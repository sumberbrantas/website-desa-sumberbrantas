...
const DownloadFormulirSection = () => {
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm p-6 mt-8">
      <h2 className="text-xl font-bold text-[#556846] mb-2">Unduh Formulir</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {formulirData.map((formulir) => (
          <div key={formulir.id} className="border border-gray-200 rounded-lg p-4 hover:border-[#556846] transition-colors">
            <div className="flex items-start space-x-3">
              <div className="flex-1">
                ...
                <button onClick={() => handleDownload(formulir)} className="inline-flex items-center px-3 py-1.5 bg-[#556846] text-white text-xs font-medium rounded hover:bg-[#152f5a] transition-colors">
