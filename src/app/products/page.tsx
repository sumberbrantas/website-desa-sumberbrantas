        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          ...
          {loading ? (
            ...
            <div className="text-center py-16">
              <p className="text-xl text-gray-500">{searchTerm || selectedCategory !== "all" ? "Tidak ada produk yang sesuai" : "Belum ada produk yang tersedia"}</p>
            </div>
          ) : (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {filteredProducts.map((product) => {
                ...
                return (
                  <div key={product.id} className="group bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-gray-100">
                    ...
                    <div className="p-4">
                      ...
                      <p className="text-sm text-gray-600 line-clamp-2 mb-3 min-h-[2.5rem]">{product.description}</p>
                      ...
                      {waLink ? (
                        ...
                        <div className="w-full py-2.5 rounded-lg font-medium bg-gray-100 text-gray-400 text-center">WhatsApp tidak tersedia</div>
                      )}
                    </div>
                  </div>
                );
